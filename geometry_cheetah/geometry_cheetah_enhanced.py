...
class Level:
    def __init__(self, level_num, name, description, color):
        ...
        if level_num == 1:
            ...
            self.obstacle_spawn_rate = 0.015
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Geometry Cheetah - Enhanced")
    ...
    def draw_menu(self):
        ...
        subtitle = self.font.render("Enhanced Edition", True, YELLOW)
